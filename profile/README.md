...
> 💡 Everything on this page is **live**: the repo list, stars, forks and language mix below are pulled from the GitHub API and auto-refresh every 3 hours — new public repos appear here automatically, removed ones disappear. Private repos are never shown.
...
<!-- POTENFYR:START:meta -->
<sub>⚡ Last refreshed **2026-09-08 21:16 UTC** · Data source: GitHub REST API (public repos only) · Auto-updated every 3 hours by [GitHub Actions](https://github.com/PotenFYR-Studios/.github/blob/main/.github/workflows/update-profile-readme.yml)</sub>
