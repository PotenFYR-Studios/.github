...
<picture>
  <source media="(prefers-color-scheme: dark)" srcset="https://api.star-history.com/svg?repos=potenfyr-studios/authcore,potenfyr-studios/discord-botlists,potenfyr-studios/statfyr,potenfyr-studios/shell-eggs,potenfyr-studios/potenfyr-nest,potenfyr-studios/.web,potenfyr-studios/prog-language-eggs,potenfyr-studios/database-eggs&type=Date&theme=dark">
...
<!-- POTENFYR:START:meta -->
<sub>⚡ Last refreshed **2026-09-10 18:45 UTC** · Data source: GitHub REST API (public repos only) · Auto-synced continuously by [GitHub Actions](https://github.com/PotenFYR-Studios/.github/blob/main/.github/workflows/update-profile-readme.yml)</sub>
